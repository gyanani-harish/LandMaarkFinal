...
export const Section5Card: Cards[] = [
  ...
  {
    id: 4,
    title: "LandMaark Golden Sands",
    location: "Jaipur Road, Ajmer, Rajasthan",
    price: "FROM INR 55 LAKHS*",
